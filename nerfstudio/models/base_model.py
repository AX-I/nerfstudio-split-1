...
class Model(nn.Module):
    ...
    def forward(self, ray_bundle: RayBundle, is_eval: bool = False) -> Dict[str, Union[torch.Tensor, List]]:
        ...
        return self.get_outputs(ray_bundle, is_eval)
    ...
    def get_outputs_for_camera_ray_bundle(self, camera_ray_bundle: RayBundle,
                                          is_eval: bool = False) -> Dict[str, torch.Tensor]:
        ...
        for i in range(0, num_rays, num_rays_per_chunk):
            ...
            outputs = self.forward(ray_bundle=ray_bundle, is_eval=is_eval)
